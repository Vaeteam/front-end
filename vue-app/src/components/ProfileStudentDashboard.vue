                ...
                <div class="col-sm-6 col-lg-4 mb-3 mb-lg-0">
                    <div class="d-flex justify-content-center align-items-center p-4 bg-orange bg-opacity-15 rounded-3">
                        ...
                        <div class="ms-4">
                            ...
                            <p class="mb-0 h6 fw-light">Khóa học</p>
                        </div>
                    </div>
                </div>
                <!-- Counter item -->
                <div class="col-sm-6 col-lg-4 mb-3 mb-lg-0">
                    <div class="d-flex justify-content-center align-items-center p-4 bg-purple bg-opacity-15 rounded-3">
                        ...
                        <div class="ms-4">
                            ...
                            <p class="mb-0 h6 fw-light">Khóa học đã hoàn thành</p>
                        </div>
                    </div>
                </div>
                <!-- Counter item -->
                <div class="col-sm-6 col-lg-4 mb-3 mb-lg-0">
                    <div class="d-flex justify-content-center align-items-center p-4 bg-success bg-opacity-10 rounded-3">
                        ...
                        <div class="ms-4">
                            ...
                            <p class="mb-0 h6 fw-light">Chứng chỉ đã đạt</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row g-3 align-items-center justify-content-between mb-4">
                        ...
                        <div class="col-md-8">
                            <form class="rounded position-relative">
                                <input class="form-control pe-5 bg-transparent" type="search" placeholder="Tìm khóa học"
                                    aria-label="Search">
                        ...
                        <div class="col-md-3">
                            ...
                            <form>
                                <select class="form-select js-choice border-0 z-index-9 bg-transparent"
                                    ...
                                    <option>Nhiều người học nhất</option>
                                    <option>Nhiều người tham khảo nhất</option>
                                </select>
                            </form>
                        </div>
                    </div>
                        ...
                        <table class="table table-dark-gray align-middle p-4 mb-0 table-hover">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" class="border-0">Tổng số bài học</th>
                                    <th scope="col" class="border-0">Bài học đã hoàn thành</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <!-- Image -->
                                            <div class="w-100px">
                                                <img src="/src/assets/images/courses/4by3/08.jpg" class="rounded" alt="">
                                            </div>
                                            <div class="mb-0 ms-2">
                                                <!-- Title -->
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <!-- Image -->
                                            <div class="w-100px">
                                                <img src="/src/assets/images/courses/4by3/03.jpg" class="rounded" alt="">
                                            </div>
                                            <div class="mb-0 ms-2">
                                                <!-- Title -->
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <!-- Image -->
                                            <div class="w-100px">
                                                <img src="/src/assets/images/courses/4by3/05.jpg" class="rounded" alt="">
                                            </div>
                                            <div class="mb-0 ms-2">
                                                <!-- Title -->
                                                ...
                                                <div class="overflow-hidden">
                                                    ...
                                                    <div class="progress progress-sm bg-primary bg-opacity-10">
                                                        <div class="progress-bar bg-primary aos" role="progressbar"
                                                            data-aos="slide-right" data-aos-delay="200" data-aos-duration="1000"
                                                            data-aos-easing="ease-in-out" style="width: 60%" aria-valuenow="60"
                                                            aria-valuemin="0" aria-valuemax="100">
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <!-- Image -->
                                            <div class="w-100px">
                                                <img src="/src/assets/images/courses/4by3/01.jpg" class="rounded" alt="">
                                            </div>
                                            <div class="mb-0 ms-2">
                                                <!-- Title -->
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <!-- Image -->
                                            <div class="w-100px">
                                                <img src="/src/assets/images/courses/4by3/02.jpg" class="rounded" alt="">
                                            </div>
                                            <div class="mb-0 ms-2">
                                                <!-- Title -->
