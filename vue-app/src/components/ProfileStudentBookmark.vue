    						...
    						<div class="row g-4">
    							...
    							<div class="col-sm-6 col-lg-4">
    								<div class="card shadow h-100">
    									<!-- Image -->
    									<img src="/src/assets/images/courses/4by3/02.jpg" class="card-img-top" alt="course image">
    							...
    							<div class="col-sm-6 col-lg-4">
    								<div class="card shadow h-100">
    									<!-- Image -->
    									<img src="/src/assets/images/courses/4by3/07.jpg" class="card-img-top" alt="course image">
    									<div class="card-body pb-0">
    										<!-- Badge and favorite -->
    										<div class="d-flex justify-content-between mb-2">
    											<a href="#" class="badge bg-success bg-opacity-10 text-success">Beginner</a>
    							...
    							<div class="col-sm-6 col-lg-4">
    								<div class="card shadow h-100">
    									<!-- Image -->
    									<img src="/src/assets/images/courses/4by3/11.jpg" class="card-img-top" alt="course image">
    									<div class="card-body pb-0">
    										<!-- Badge and favorite -->
    										<div class="d-flex justify-content-between mb-2">
    							...
    							<div class="col-sm-6 col-lg-4">
    								<div class="card shadow h-100">
    									<!-- Image -->
    									<img src="/src/assets/images/courses/4by3/10.jpg" class="card-img-top" alt="course image">
    									<div class="card-body pb-0">
    										<!-- Badge and favorite -->
    										<div class="d-flex justify-content-between mb-2">
    							...
    							<div class="col-sm-6 col-lg-4">
    								<div class="card shadow h-100">
    									<!-- Image -->
    									<img src="/src/assets/images/courses/4by3/04.jpg" class="card-img-top" alt="course image">
    									<div class="card-body pb-0">
    										<!-- Badge and favorite -->
    										<div class="d-flex justify-content-between mb-2">
    											<a href="#" class="badge bg-purple bg-opacity-10 text-purple">All level</a>
    										...
    										<ul class="list-inline mb-0">
    											...
    											<li class="list-inline-item me-0 small"><i class="fas fa-star text-warning"></i></li>
    											<li class="list-inline-item me-0 small"><i class="fas fa-star text-warning"></i></li>
    											<li class="list-inline-item me-0 small"><i class="fas fa-star-half text-warning"></i></li>
    											<li class="list-inline-item me-0 small"><i class="far fa-star text-warning"></i></li>
    							...
    							<div class="col-sm-6 col-lg-4">
    								<div class="card shadow h-100">
    									<!-- Image -->
    									<img src="/src/assets/images/courses/4by3/01.jpg" class="card-img-top" alt="course image">
    									<div class="card-body pb-0">
    										<!-- Badge and favorite -->
    										<div class="d-flex justify-content-between mb-2">
    											<a href="#" class="badge bg-success bg-opacity-10 text-success">Beginner</a>
