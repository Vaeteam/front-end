    				...
    				<div class="card border">
    					<div class="card-header border-bottom">
    						...
    						<div class="card">
    							<div class="row g-0">
    								<div class="col-md-3">
    									<img src="/src/assets/images/courses/4by3/01.jpg" class="rounded-2" alt="Card image">
    								</div>
    								<div class="col-md-9">
    									<div class="card-body">
    										<!-- Title -->
    										...
    										<ul class="list-inline mb-2">
    											...
    											<li class="list-inline-item h6 fw-light mb-1 mb-sm-0"><i class="fa-table text-orange me-2"></i>82 lectures</li>
    											<li class="list-inline-item h6 fw-light"><i class="fa-signal text-success me-2"></i>Beginner</li>
    										</ul>
    						...
    						<div class="accordion accordion-icon accordion-bg-light" id="accordionExample2">
    							...
    							<div class="accordion-item mb-3">
    								<h6 class="accordion-header font-base" id="heading-1">
    									<a class="accordion-button font-weight-bold rounded collapsed d-block pe-4" href="#collapse-1" data-bs-toggle="collapse" data-bs-target="#collapse-1" aria-expanded="true" aria-controls="collapse-1">
    				...
    				<div class="card border mt-4">
    					<div class="card-header border-bottom">
    						...
    						<div class="card">
    							<div class="row g-0">
    								<div class="col-md-3">
    									<img src="/src/assets/images/courses/4by3/08.jpg" class="rounded-2" alt="Card image">
    								</div>
    								<div class="col-md-9">
    									<div class="card-body">
    										<!-- Title -->
    										...
    										<ul class="list-inline mb-2">
    											...
    											<li class="list-inline-item h6 fw-light mb-1 mb-sm-0"><i class="fa-table text-orange me-2"></i>65 lectures</li>
    											<li class="list-inline-item h6 fw-light"><i class="fa-signal text-success me-2"></i>All level</li>
    										</ul>
    										<!-- Button -->
    										<a href="#" class="btn btn-primary-soft btn-sm mb-0">Resume course</a>
    									</div>
